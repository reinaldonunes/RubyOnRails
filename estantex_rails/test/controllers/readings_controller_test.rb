...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference("Reading.count") do
      post readings_url, params: { reading: { evaluation: @reading.evaluation, month: @reading.month, progress: @reading.progress } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { evaluation: @reading.evaluation, month: @reading.month, progress: @reading.progress } }
